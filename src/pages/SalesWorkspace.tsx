            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <Card className="p-4">
                ...
                <div className="flex gap-4 mb-4 border-b border-core-subtle">
                  <button className="pb-2 px-1 border-b-2 border-primary body-125 text-foreground">
                    Prospects
                  </button>
                  <button className="pb-2 px-1 border-b-2 border-transparent body-100 text-muted-foreground hover:text-foreground">
                    Agents
                  </button>
                  <button className="pb-2 px-1 border-b-2 border-transparent body-100 text-muted-foreground hover:text-foreground">
                    Team
