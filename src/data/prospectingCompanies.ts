...
const company1Contacts = [
  { id: "c1", name: "Jennifer Park", initials: "JP", role: "VP, Marketing", avatarColor: "bg-trellis-purple-600", recentTouches: 2, enrolledInSequence: true, recentConversions: 1, signals: [SIGNALS.COMPETITIVE_RENEWAL, SIGNALS.NON_QL_DEMAND] },
  { id: "c2", name: "Keisha Blue", initials: "KB", role: "Marketing Director", avatarColor: "bg-trellis-blue-600", recentTouches: 1, enrolledInSequence: false, recentConversions: 0, signals: [SIGNALS.RECENT_FUNDING] },
  ...
  { id: "c1a", name: "Marcus Chen", initials: "MC", role: "Sr. Product Manager", avatarColor: getRandomColor(), recentTouches: getRandomTouches(), enrolledInSequence: getRandomEnrollment(), recentConversions: 0, signals: [SIGNALS.MARKETING_HUB_QL] },
  { id: "c1b", name: "Diana Ross", initials: "DR", role: "Content Lead", avatarColor: getRandomColor(), recentTouches: getRandomTouches(), enrolledInSequence: getRandomEnrollment(), recentConversions: 1, signals: [] },
  { id: "c1c", name: "Victor Huang", initials: "VH", role: "Growth Manager", avatarColor: getRandomColor(), recentTouches: getRandomTouches(), enrolledInSequence: getRandomEnrollment(), recentConversions: 0, signals: [SIGNALS.RECENT_FUNDING, SIGNALS.THIRD_PARTY_INTENT] },
  { id: "c1d", name: "Sophia Martinez", initials: "SM", role: "Demand Gen Lead", avatarColor: getRandomColor(), recentTouches: getRandomTouches(), enrolledInSequence: getRandomEnrollment(), recentConversions: 2, signals: [SIGNALS.NON_QL_DEMAND] },
];
