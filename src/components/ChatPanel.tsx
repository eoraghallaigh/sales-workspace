...
export const ChatPanel = ({ isOpen, onClose, selectedText, context }: ChatPanelProps) => {
  ...
  const renderExplanationContent = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        {/* Assistant Response */}
        <div className="space-y-4">
          <h3 className="heading-50 text-foreground">Success Assistant</h3>
  ...
  const renderDefaultContent = () => (
    <div className="space-y-6">
      {/* Main Title */}
      <h2 className="heading-400 text-muted-foreground">Success Assistant</h2>
      
      {/* Greeting */}
      <div className="space-y-2">
        <h3 className="heading-300 text-foreground">Hi Olivia 👋</h3>
        <p className="body-200 text-muted-foreground">How can Success Assistant help you today?</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        >
          ...
          <span className="detail-100">Discover Success Assistant features</span>
        </Button>
    ...
    <div className="fixed top-12 right-0 w-96 h-[calc(100vh-48px)] bg-card border-l border-border shadow-lg z-40 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        <Button variant="secondary-alt" size="small" className="flex items-center gap-2">
          <span className="body-200">Success Assistant</span>
