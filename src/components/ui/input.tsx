    ...
    return (
      <input
        ...
        className={cn(
          ...
          "rounded-[var(--borderRadius-100,4px)] border-[length:var(--borderWidth-100,1px)] border-solid border-[hsl(var(--color-border-core-default,54%))] bg-[var(--color-fill-field-default,#FFF)]",
          className
        )}
        ref={ref}
        {...props}
