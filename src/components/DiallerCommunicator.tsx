...
const DiallerCommunicator = ({
  ...
  return (
    <div 
      className="fixed bg-card z-50 flex flex-col shadow-lg rounded-lg animate-scale-in overflow-hidden border border-border"
      style={{
        width: '540px',
        bottom: '20px',
        left: '84px',
    ...
    >
      {/* Header - Dark with contact info and call controls */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#33475B]">
