import { Search, Plus, HelpCircle, Settings, Bell, User, ChevronDown, X, Star, MessageSquare } from "lucide-react";
            ...
            <div className="flex flex-col h-[calc(100vh-73px)]">
              <div className="flex-1 overflow-y-auto p-4" id="chat-content">
                {showChatHistory ? <>
                    ...
                    <h2 className="body-125 text-foreground mb-2">Success Assistant</h2>
